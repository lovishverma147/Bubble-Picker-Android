...
import com.lovish.bubblepicker.*
import com.lovish.bubblepicker.model.Color
import com.lovish.bubblepicker.model.PickerItem
import com.lovish.bubblepicker.physics.Engine
import com.lovish.bubblepicker.rendering.BubbleShader.A_POSITION
import com.lovish.bubblepicker.rendering.BubbleShader.A_UV
import com.lovish.bubblepicker.rendering.BubbleShader.U_BACKGROUND
import com.lovish.bubblepicker.rendering.BubbleShader.fragmentShader
import com.lovish.bubblepicker.rendering.BubbleShader.vertexShader
...
class PickerRenderer(private val glView: View) : GLSurfaceView.Renderer {
    ...
    private fun getItem(position: Vec2) = position.let { it ->
